<div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li class="sidebar-brand"><a href="<?php echo base_url().'welcome'?>"><img src="<?php echo base_url().'assets/img/logonewrmk.png'?>" style="width:80px">  OecaX Tech</a>
                </li>
        ...
        <div id="page-content-wrapper">
            <div class="content-header">
                <h1>
                    ...
                    <img src="<?php echo base_url().'assets/img/logonewrmk.png'?>" style="width:90px"> <small>POS Oecax Tech</small>
                </h1>
            </div>
