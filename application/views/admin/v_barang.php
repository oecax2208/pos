...
<head>
    ...
    <meta name="description" content="Oecax bond">
    <meta name="author" content="Oecax technologies">

    <title>Pos Oecax Tech</title>
    <?php 
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/edit_barang'?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                 <select name="satuan" class="selectpicker show-tick form-control" data-live-search="true" title="Pilih Satuan" data-width="80%" placeholder="Pilih Satuan" required>
                                    <?php if($satuan=='1M3'):?>
                                        <option selected>1M3</option>
                                        <option>2M3</option>
                                        <option>6M3</option>
                                        <option>7M3</option>
                                    <?php elseif($satuan=='2M3'):?>
                                        <option>1M3</option>
                                        <option selected>2M3</option>
                                        <option>6M3</option>
                                        <option>7M3</option>
                                    <?php elseif($satuan=='6M3'):?>
                                        <option>1M3</option>
                                        <option>2M3</option>
                                        <option selected>6M3</option>
                                        <option>7M3</option>
                                    <?php elseif($satuan=='7M3'):?>
                                        <option>1M3</option>
                                        <option>2M3</option>
                                        <option>6M3</option>
                                        <option selected>7M3</option>
                                    <?php endif;?>
                                 </select>
                            </div>
                        </div>
